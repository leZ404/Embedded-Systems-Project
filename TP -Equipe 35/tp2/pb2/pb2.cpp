...
//imposée par l'énoncé qui change la couleur d'une LED en fonction du bouton où l'on appuie entre les boutons D2 et D3.
//Le programme prend en compte l'état courant afin de savoir quel sera l'état prochain.
//On remarquera que à l'état initial la DEl est rouge.
//Nous avons utilisé une fonction appuiBouton et  afin de traiter le problème de debounce, nous avons inclus un délais anti_rebond de 10 ms dans la fonction appuiBouton.
// Aussi nous avons déclarer nos 3 états ROUGE, ETEINT, VERT afin de pouvoir les réferer à notre switch (etatCourant)

//Identifications matérielles (Broches I/O):
//
//INT 0/1: PIND2; PIND3; DDRD --> Ces input prennent comme valeur 0 ou 1 afin de savoir si le courant passe ou non.
//Analog Digital Converter: PA0; PA1; DDRA --> Ces Output ressort le courant conduit par les boutons poussoirs. PA0 ressort le courant afin d'allumer la DEL bicoolore en vert
//et PA1 allume la DEL bicolore en rouge
//Ils ont été traité par le microprocesseur atmega afin d'allumer la LED en rouge, en vert ou pas.
